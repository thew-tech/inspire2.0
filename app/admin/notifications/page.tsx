      ...
      const mockNotifications: Notification[] = [
        {
          ...
          message: 'A new inspector "John Smith" has registered and is pending approval.',
          type: 'info',
          isRead: false,
        ...
        },
        {
          ...
          message: 'User account "mike@example.com" has been deactivated due to inactivity.',
          type: 'info',
          isRead: true,
        ...
        <div className="flex gap-2 mb-6">
          {['all', 'unread', 'read'].map((f) => (
            <button
              ...
              className={`px-4 py-2 rounded-lg text-sm font-medium transition-colors ${filter === f ? 'bg-[#1E3A5F] text-white' : 'bg-white text-gray-700 hover:bg-gray-100'}`}
            >
